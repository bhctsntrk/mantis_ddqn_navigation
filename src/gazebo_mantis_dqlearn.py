...
class MantisGymEnv():
    ...
    def __init__(self):
        ...
        self.minCrashRange = 0.3  # Asume crash below this distance
    ...
    def getOdomData(self):
        ...
        try:
            odomData = rospy.wait_for_message('/diffdrive/odom', Odometry, timeout=5)
    ...
    def calculateState(self, laserData, odomData):
        ...
        distance = self.calcDistance(robotX, robotY, self.targetPointX, self.targetPointY)
    ...
    def reset(self):
        ...
        while True:
            # Teleport mantis to a random point
            ...
            if self.calcDistance(self.targetPointX, self.targetPointY, agentX, agentY) > self.minCrashRange:
                ...
                rospy.logerr("Re teleporting the mantis!")
                time.sleep(2)
