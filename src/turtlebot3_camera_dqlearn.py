...
from gazebo_turtlebot3_camera_dqlearn import GazeboTurtlebot3CameraNnEnv
...
class DeepQ:
    ...
    def createModel(self):
        ...
        model = Sequential()
        model.add(Convolution2D(16, (3,3), padding='same', input_shape=(img_channels,img_rows,img_cols)))
        model.add(Activation('relu'))
        model.add(ZeroPadding2D((1, 1)))
        model.add(Convolution2D(16, (3,3), padding='same', subsample=(2,2)))
        model.add(Activation('relu'))
